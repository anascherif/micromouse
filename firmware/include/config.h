...
// Left sensor
#define US_LEFT_TRIG_PIN ((gpio_num_t)33)
#define US_LEFT_ECHO_PIN ((gpio_num_t)32)
// Front sensor
#define US_FRONT_TRIG_PIN ((gpio_num_t)19)
#define US_FRONT_ECHO_PIN ((gpio_num_t)21)
// Right sensor
#define US_RIGHT_TRIG_PIN ((gpio_num_t)26)
#define US_RIGHT_ECHO_PIN ((gpio_num_t)25)
...
#define MOTOR_L_IN1_PIN 16
#define MOTOR_L_IN2_PIN 4
// #define MOTOR_L_PWM_PIN          18
//  Right motor: IN1, IN2, PWM
#define MOTOR_R_IN1_PIN 18
#define MOTOR_R_IN2_PIN 17
...
// Left encoder: A, B
#define ENC_L_A_PIN ((gpio_num_t)35)
#define ENC_L_B_PIN ((gpio_num_t)34)
// Right encoder: A, B
#define ENC_R_A_PIN ((gpio_num_t)36)
#define ENC_R_B_PIN ((gpio_num_t)39)
